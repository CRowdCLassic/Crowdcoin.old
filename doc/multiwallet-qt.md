...
Only requiring some minor changes is crowdclassic.cpp.
...
Changes to crowdclassic.cpp
----------------------
crowdclassic.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
