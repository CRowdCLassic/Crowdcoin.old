...
This mechanism has been integrated into Bitcore-Node-CRowdCLassic which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/crowdclassiccoin/insight-api-crowdclassic#web-socket-api](https://github.com/crowdclassiccoin/insight-api-crowdclassic#web-socket-api) 
* API: [https://github.com/crowdclassiccoin/insight-api-crowdclassic#instantsend-transactions](https://github.com/crowdclassiccoin/insight-api-crowdclassic#instantsend-transactions) 
...
By default, the CRowdCLassic Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CRowdCLassic Core daemon:
