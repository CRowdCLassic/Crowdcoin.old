...
{
    if(fLiteMode) return; // ignore all CRowdCLassic related functionality
...
/*
    ...
    allow endless transaction that would bloat CRowdCLassic and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("crowdclassic-privatesend");
