...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("CRowdCLassic Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  crowdclassic-cli [options] <command> [params]  " + _("Send command to CRowdCLassic Core") + "\n" +
                  "  crowdclassic-cli [options] help                " + _("List commands") + "\n" +
                  "  crowdclassic-cli [options] help <command>      " + _("Get help for a command") + "\n";
