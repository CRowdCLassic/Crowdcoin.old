...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CRowdCLassic Core crowdclassic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  crowdclassic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crowdclassic transaction") + "\n" +
              "  crowdclassic-tx [options] -create [commands]   " + _("Create hex-encoded crowdclassic transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded crowdclassic transaction
