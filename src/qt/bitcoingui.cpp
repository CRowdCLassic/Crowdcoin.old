    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("CRowdCLassic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CRowdCLassic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crowdclassic: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About CRowdCLassic Core"), this);
    aboutAction->setStatusTip(tr("Show information about CRowdCLassic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CRowdCLassic Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CRowdCLassic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CRowdCLassic addresses"));
    ...
    openAction->setStatusTip(tr("Open a crowdclassic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CRowdCLassic Core help message to get a list with possible CRowdCLassic Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("CRowdCLassic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CRowdCLassic network", "", count));
}
...
{
    QString strTitle = tr("CRowdCLassic Core"); // default title
    ...
    // Append title to "CRowdCLassic Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
