    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CRowdCLassic Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CRowdCLassic Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  crowdclassic-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CRowdCLassic in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CRCL, 0.1 CRCL, 1 CRCL and 10 CRCL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://crowdclassiccoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://crowdclassiccoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CRowdCLassic Core is shutting down...") + "<br /><br />" +
