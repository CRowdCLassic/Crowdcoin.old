...
2. run crowdclassicd with -printalert or -sendalert like this:
   /path/to/crowdclassicd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.crowdclassic.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CRowdCLassic Core:0.12.0.58/"));
